      ...
      {zoomedScreenshot && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="relative w-full max-w-5xl bg-[#FAF8F5] rounded-3xl border border-[#E7DFD5] shadow-2xl p-6 sm:p-8 max-h-[92vh] overflow-y-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-[#EAE3D8]">
              <span className="text-xs text-[#7A6C5E]">
                Fichier source : <code className="font-mono text-[#2D241E]">{zoomedScreenshot.screenshot.imageFileName}</code>
              </span>
              <div className="flex items-center gap-3">
                <button
                  type="button"
